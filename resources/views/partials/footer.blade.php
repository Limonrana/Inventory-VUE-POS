...
<footer class="footer text-center">
    All Rights Reserved by Inventory. Designed and Developed by
    <a href="#">Limon Rana</a>.
</footer>
<!-- ============================================================== -->
<!-- End footer -->
...
<!-- customizer Panel -->
<!-- ============================================================== -->
<aside class="customizer" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/register' || $route.path === '/forgot-password' ? false : true">
...
<!-- Image Upload JS -->
<script src="{{ asset('backend/assets/libs/dropzone/dist/min/dropzone.min.js') }}"></script>
<!-- Editor Page JS -->
...
{{--<script src="{{ asset('backend/assets/libs/footable/js/footable.min.js') }}"></script>--}}
<script src="{{ asset('backend/dist/js/pages/tables/footable-init.js') }}"></script>
