...
<div id="main-wrapper">
    ...
    <!-- ============================================================== -->
    <header class="topbar" id="mytopbar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/register' || $route.path === '/forgot-password' ? false : true">
            ...
            <div class="navbar-header">
                ...
                <!-- ============================================================== -->
                    ...
                    <span class="logo-text mt-2">
                            <!-- dark Logo text -->
                            <h3 class="dark-logo text-dark">INVENTORIY</h3>
                        <!-- Light Logo text -->
                            <h3 class="light-logo text-white">INVENTORIY</h3>
                        </span>
                </router-link>
                <!-- ============================================================== -->
                <!-- End Logo -->
                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false">
                            <img src="{{ asset('uploads/users/admin.png') }}" alt="user" class="rounded-circle" width="31">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                <div class="">
                                    <img src="{{ asset('uploads/users/admin.png') }}" alt="user" class="img-circle" width="60">
                                </div>
                                <div class="m-l-10">
                                    <h4 class="m-b-0">Limon Rana</h4>
                                    <p class=" m-b-0">limon515@gmail.com</p>
                                </div>
                            </div>
