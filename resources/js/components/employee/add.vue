                ...
                <div class="col-sm-12 col-lg-12 m-auto">
                    ...
                    <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Please fill-up all data from below and publish and generate new employee.</h6>
                            </div>
                            <hr>
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="action-form">
                            <div class="form-group m-b-0 mt-3 text-right">
                                ...
                                <a href="#" class="btn btn-dark waves-effect waves-light">Cancel</a>
                            </div>
                        </div>
                </form>
                </div>
