                                            ...
                                            <tr>
                                                ...
                                                <td width="20%">
                                                                ...
                                                                <div class="el-card-avatar el-overlay-1"> <img :src="`/uploads/products/${form.photo}`"/>
                                                                    <div class="el-overlay">
                                                                        <ul class="list-style-none el-info">
                                                                            <li class="el-item"><a class="btn default btn-outline el-link" @click="deleteImage(false)"><i class="sl-icon-trash"></i></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-actions m-t-40 text-right">
                                                        <button type="submit" class="btn btn-info btn-md"> <i class="fa fa-check"></i> Update</button>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
